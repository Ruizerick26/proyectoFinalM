...
import 'package:proyecto_final/IniciarSesion/login.dart';
...
class PaginaRegistroState extends State<PaginaRegistro> {
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [const Color.fromRGBO(0, 121, 107, 1)!, const Color.fromRGBO(77, 182, 172, 1)!],
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) {
                        ...
                        } else if (value != _contrasenaController1.text) {
  ...
  Future<void> registroNuevoUsuario(BuildContext context) async {
    ...
    try {
      ...
      // Agregar el usuario a Firestore con el nombre y el valor activo
